...
def mtFeatureExtractionToFile(fileName, outPutFile, storeStFeatures=False, storeToCSV=False, PLOT=False):
    """
...
def mtFeatureExtractionToFileDir(dirName, storeStFeatures=False, storeToCSV=False, PLOT=False):
    ...
    for f in filesToProcess:
        outPath = f
        mtFeatureExtractionToFile(f, outPath, storeStFeatures, storeToCSV, PLOT)
